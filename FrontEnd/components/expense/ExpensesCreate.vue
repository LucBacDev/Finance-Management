...
import { expenseValidation } from "../composables/expenseValidation"; // Import the validation logic
...
const { validationSchema } = expenseValidation(); // Use the validation schema
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // Nếu là lỗi từ API
      ...
      const apiErrors = validationError.response.data.errors;
